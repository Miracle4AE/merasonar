# RC1 — Map hotspot detail panel screenshot (Windows release exe)
param(
  ...
  [string]$FileName = "map-hotspot-detail-panel.png"
)
...
# Dashboard map preview card -> MapScreen
[MeraSonarWin]::Click($hwnd, 520, 380)
Start-Sleep -Seconds 6
# First hotspot strip card (Yakındaki Meralar)
[MeraSonarWin]::Click($hwnd, 180, 720)
